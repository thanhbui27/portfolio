...
import { getSiteConfig, getSocialLinks, getVisibleSections } from "@/lib/portfolio-service";
...
export async function PageShell({
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-hidden">
      ...
      <Footer className={footerClassName} config={config} socialLinks={socialLinks} />
    </div>
  );
}
